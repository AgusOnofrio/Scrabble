...
// The above code is creating the buttons for the rack and the board.
        rackButton1 = new JButton();
        rackButton2 = new JButton();
        rackButton3 = new JButton();
        rackButton4 = new JButton();
        rackButton5 = new JButton();
        rackButton6 = new JButton();
        rackButton7 = new JButton();
        ...
        buttonRack.add((JButton) rackButton1);
        buttonRack.add((JButton) rackButton2);
        buttonRack.add((JButton) rackButton3);
        buttonRack.add((JButton) rackButton4);
        buttonRack.add((JButton) rackButton5);
        buttonRack.add((JButton) rackButton6);
        buttonRack.add((JButton) rackButton7);
        ...
        for (int i = 0; i < tablero.TAMANIO; i++) {
            ...
            for (int j = 0; j < tablero.TAMANIO; j++) {
                ...
                spaceButtonList.add(new JButton());
                JButton espacio= spaceButtonList.get((i*15)+j);
                

                Casillero casilleroActual= tablero.getCasilleros()[i][j];

                spaceButtonList.get((i*15)+j).setText(casilleroActual.getTipoEspecial().toString());

                

              
                        switch (espacio.getText()) {
                            case "SIMPLE":
    ...
    public void updateRack(Ijugador player) throws IndexOutOfBoundsException {
        ...
        for (int i = 0; i < player.getAtril().getFichasAtril().size(); i++) {
            ...
            if (assignedTile.getValue() == 0) {
                ...
                System.out.println("Aca se supone que se setean los valores de cada casillero");
            }//end if
    ...
    public void updateBoard(Tablero gameBoard) {
        for (int i = 0; i < gameBoard.TAMANIO; i++) {

            //if space does not have an assigned tile
            if (gameBoard.getCasilleros()[i][i].getFicha() == null) {

                //setup button labels for appropriate non occupied spaces
                if (gameBoard.getCasilleros()[i][i].getTipoEspecial()==TipoEspecial.TRIPLE_PALABRA) {
                    spaceButtonList.get(i).setBackground(Color.RED);
                } else if (gameBoard.getCasilleros()[i][i].getTipoEspecial()==TipoEspecial.TRIPLE_LETRA) {
                    spaceButtonList.get(i).setBackground(Color.BLUE);
                } else if (gameBoard.getCasilleros()[i][i].getTipoEspecial()==TipoEspecial.DOBLE_PALABRA) {
                    spaceButtonList.get(i).setBackground(Color.PINK);
                } else if (gameBoard.getCasilleros()[i][i].getTipoEspecial()==TipoEspecial.DOBLE_LETRA) {
            ...
            if (gameBoard.posicionValida(i, i)) {
                spaceButtonList.get(i).setEnabled(true);
            } else {
                spaceButtonList.get(i).setEnabled(false);
            }//end if
    ...
    public void setButtonRack(ArrayList<JButton> newButtonRack) {
        buttonRack = newButtonRack;
    }//end setter

    public ArrayList<JButton> getButtonRack() {
        return buttonRack;
    }//end getter

    public ArrayList<JButton> getSpaceButtonList() {
    ...
    private ArrayList<JButton> buttonRack;
    private ArrayList<JButton> spaceButtonList;
